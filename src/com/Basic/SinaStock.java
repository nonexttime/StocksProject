...
public class SinaStock {
	private static String db  = "O:\\MyProjects\\sina-stock-codes.txt" ;
	...
	public static String[]  getStockInfoByCode(String stockCode) throws IOException{
		// 仅仅打印
		 ...
		 if(sb.length() > 0 ){
			 ...
			 stock.setCurrentDate(Timestamp.valueOf(sdf.format(rss[30] + " " + rss[31])));
			 ...
			 //System.out.println("StockOpenPrice:" + stock.getStockOpenPrice());
			 //System.out.println("currentDate:" + sdf.format(stock.getCurrentDate()));
			 System.out.println("CurrentTime:" + stock.getCurrentTime());
